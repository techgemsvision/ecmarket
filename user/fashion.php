...
$expensive="SELECT * FROM `product` WHERE p_type=1 and (`status`='on') GROUP by p_price DESC LIMIT 4";
$conn2=mysqli_query($connect,$expensive);
$expensive1="SELECT * FROM `product` WHERE p_type=1  and (`status`='on') GROUP by p_price DESC LIMIT 9999999999999 OFFSET 4";
