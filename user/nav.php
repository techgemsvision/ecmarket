                            ...
                            <div class="dropdown category-dropdown show is-on" data-visible="true">
                                ...
                                <div class="dropdown-menu show">
                                    <nav class="side-nav">
                                        ...
                                        <li><a href="fashion.php"><i class="icon-gift"></i>Fashion</a></li>
                                            <li><a href="jewelry.php"><i class="icon-gift"></i>Jewellery</a></li>
                                            <li><a href="electronic.php"><i class="icon-gift"></i>Electronics</a></li>
                                        </ul>
                                        <img src="../admin/f_image/<?php echo $fetchrandom['p_image']?>">
                                    </nav><!-- End .side-nav -->
                                </div><!-- End .dropdown-menu -->
