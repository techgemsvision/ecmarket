...
include 'img.php';
$query="SELECT * FROM `product` where `p_type`=3";
$connn=mysqli_query($connect,$query);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">
                   ...
                   <br>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-window-maximize me-2"></i>View_Product</a>
                        <div class="dropdown-menu bg-transparent border-0">
...
include 'alert.php';
?>
<h1 class="h11">View Electronics Items</h1>
...
while($fetch=mysqli_fetch_assoc($connn)){
    echo"
    ...
    <div class='im'>
    <br>
  <img src='../admin/f_image/".$fetch['p_image']."' class='card-img-top img' alt='...'>
  </div>
  <br>
  <div class='card-body1'>
    <h5 class='card-title1'>".$fetch['p_name']."</h5>
    <p class='card-text1'><b>Original-Price : </b><span class='cut'>".$fetch['original_price']."</span> rps</p>
    <p class='card-text1'><b>Discount : </b><span>".$fetch['discount']."% </span><span> / </span> <b> Price : </b><span>".$fetch['p_price']."</span> rps</p>
    <p class='card-text1'><b>Stock-Remaining : </b>".$fetch['stock']." ---- <b>Status : </b>". $fetch['status'] ."</p>
    <a href='updateproducts.php? id=$fetch[id] & name=$fetch[p_name] & o_price=$fetch[original_price] & 
    dis=$fetch[discount] & des=$fetch[description] & stock=$fetch[stock] & type=$fetch[p_type]'  class='update btn btn-primary'><i class='fa fa-pen-nib'></i> - Update</a> 
    <a href='deleteproduct.php? id=$fetch[id]' class='delete btn btn-primary'><i class='fa fa-trash'></i> - Delete</a>
    <br><br>
  </div>
</div>
    </div>
