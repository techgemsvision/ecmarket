...
include 'emp.php';
include 'img.php';
$query="SELECT * FROM `order_details` where (`status`='pending' or `status`='process') and `branch`=$b";
            ...
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">
                   ...
                   <br>
                    ...
                    <a href="status.php" class="nav-item active nav-link"><i class="fa fa-sitemap me-2"></i>Status</a>
...
<table class='table'>
        <thead>
            <tr>
                ...
                <th><span class="color">......</span>Coupan_Discount<span class="color">......</span></th>
                <th><span class="color">........................</span>Date<span class="color">........................</span></th>
                <th><span class="color">........................</span>Month<span class="color">........................</span></th>
                <th>Quantities</th>
                <th>Total_Amount</th>
                <th><span class="color">......</span>Choose_Status<span class="color">......</span></th>
                <th><span class="color">......</span>Update_Status<span class="color">......</span></th>
            </tr>
            </thead>
            <?php
while($row=mysqli_fetch_assoc($conn))
{
  ...
  <tr>
    ...
    <form action='stupdate.php? id=$row[id] & tracking_id=$row[tracking_id] & qtn=$row[total_qtn]' method='POST'>
    <td class='ts' colspan='2'>
    <select name='status' class='select2 gap'>
    ...
    <input type='submit' value='Update Status' name='submit' class='btngreen gap'>
    </form>
  </tr>";
}
?>
