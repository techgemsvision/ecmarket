...
$query2='SELECT * FROM `cities_pk`';
$con=mysqli_query($connect,$query2);
$query3='SELECT A.id, A.branch,B.name FROM `branch` as A inner join cities_pk as B where A.city=B.id';
$con2=mysqli_query($connect,$query3);

if(isset($_POST['sub'])){
    $name=$_POST['bname'];
    $city=$_POST['city'];

    $_SESSION['msg']="branch inserted succesfully";

    $query3="INSERT INTO `branch`(`id`, `branch`, `city`) 
                   ...
                   <br>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="vorder.php" class="dropdown-item">Orders</a>
...
<div class="text-center">
    <form method="POST" class="form form1">
        <br>
        <label for="">Branch_Name</label>
        <br><br>
    <input type="text" name="bname" placeholder="Branch Name" class="bn" pattern="[A-Za-z0-9]+(_[A-Za-z0-9]+)*" title="Only letters, numbers, and underscores are allowed. Spaces at the beginning or end are not allowed." required>
    <br><br>
...
<br>
<br>
<input type="submit" value="Create Branch" name="sub" class="btn1">
<br><br>
    </form>
<br>
<hr>
</div>
<h1 class="h11">Branches</h1>
