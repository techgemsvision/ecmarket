...
include 'img.php';
$query2='SELECT * FROM `sign_in_up` where `role`=2';
...
<tr>
  ...
  <td class='tu'><a data-bs-toggle='modal' data-bs-target='#".$row['user_name']."' href='#'>UPDATE</a></td>
  <div class='modal fade' id='".$row['user_name']."' tabindex='-1' aria-labelledby='".$row['user_name']."Label' aria-hidden='true'>
  <div class='modal-dialog modal-dialog-centered modal-dialog-scrollable'>
    <div class='modal-content'>
      <div class='modal-header'>
        <h5 class='modal-title' id='".$row['user_name']."Label'>".$row['user_name']."</h5>
        <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
      </div>
      <div class='modal-body'>" 
      ?>
<form action="userupdate.php" method="POST" class="form" enctype="multipart/form-data">
<label for="">User_ID</label>
        <br><br>
    <input type="text" name="id" value="<?php echo $row['id']?>" class="bn" required readonly>

    <br><br>
    <label for="">User Disabled or Enable</label>
        <br><br>
    <select name="status" style="width:80%" class="bn">
...
<br></br>
  ...
  <td class='td'><a href='udel.php? id=$row[id]'>DELETE</a></td>
</tr>";
}
?>
</tbody>
