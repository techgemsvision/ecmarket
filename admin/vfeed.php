...
include 'alert.php';
?>
<h1 class="h11">View Feedbacks</h1>
...
while($row=mysqli_fetch_assoc($con2))
{
    ...
    <tr>
      ...
      <td class='ts'>".$row['message']."</td>
      <td class='tu'><a href='send.php? id=$row[id] & name=$row[name] & email=$row[email] & msg=$row[message]'>Send Msg</a></td>
      <td class='td'><a href='fdel.php? id=$row[id]'>DELETE</a></td>
    </tr>";
}
?>
</tbody>
