...
if(isset($_POST['sub'])){
    ...
    $sufeed=$_POST['ufeed'];
include 'mail.php';
$_SESSION['msg1']="feedback send successfully";
...
<div class="col-sm-4">
        ...
        <br><br>
    <input type="text" name="name" value="<?php echo $name?>" class="bn" readonly>
</div>

<div class="col-sm-8">
<label for="">Email</label>
        <br><br>
    <input type="email" name="email" value="<?php echo $email?>" class="bn" readonly>
</div>
</div>
<br><br>
...
<label for="">User Feedback</label>
        <br><br>
        <textarea name="feed" id="" class="bn" cols="30" rows="5" readonly><?php echo $msg?></textarea>
</div>

<div class="col-sm-6">
<label for="">Reply Feedback</label>
        <br><br>
    <textarea name="ufeed" id="" class="bn" cols="30" rows="5"></textarea>
</div>
...
<br>
<input type="submit" value="Send FeedBack" name="sub" class="btn1">
<br></br>
    </form>
